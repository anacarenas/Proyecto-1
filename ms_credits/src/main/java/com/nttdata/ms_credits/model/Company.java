package com.nttdata.ms_credits.model;
...
public class Company implements Serializable {
   ...
   */
  public Company(String businessName, Long ruc, String email, Integer telephone, List<String> headlines, List<String> signatories, TypeProfileEnum typeProfile) {
  ...
  */
  @NotNull 
  @Schema(name = "businessName", description = "Nombre de la empresa.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.businessName, company.businessName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(businessName, ruc, email, telephone, headlines, signatories, typeProfile);
  }
